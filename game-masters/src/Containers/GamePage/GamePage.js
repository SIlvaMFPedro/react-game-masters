                    ...
                    <div className={styles.gamepageContent}>
                        ...
                        <section className={styles.game}>
                            {<Slider
                                ...
                                decrementCarousel={decrementalCarousel}
                                    ...
                                    >
                                        <AnimatedText>
                                            <div className={textExtended ? styles.open : styles.closed}>
                                                <a href={selectedGame ? selectedGame.link : templateGame.link} target="_blink">{selectedGame ? selectedGame.name: "No"}Website</a>
                                ...
                                <div className={styles.addToCart}>
                                    <div className={styles.infos}>
                                        ...
                                        <button id={selectedGame ? selectedGame.id : templateGame.id} onClick={handleLike} aria-label="Like">
                                            <Like className={selectedGame ? selectedGame.isLiked ? styles.liked : styles.like : styles.like}/>
                                        </button>
                                    </div>
