        ...
        <>
            ...
            >
                <div className={styles.navbar_left}>
                    <div className={styles.logodiv} id="0" onMouseEnter={handleHover} onMouseLeave={handleHover} onClick={handleHome}>
                    ...
                    <div className={styles.pathdiv} id="1" onMouseEnter={handleHover} onMouseLeave={handleHover}>
                        {browsing ?
                            <>
                                <motion.div
                                    animate="visible"
                                    initial={location.pathname === "/game-masters/browse" ? "hidden" : "visible"}
                ...
                <div className={styles.navbar_right}>
                    ...
                    >
                        <Cart onClick={handleOpenCart} className={styles.svg2}
